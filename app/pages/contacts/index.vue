<template>
  <div class="flex min-h-[min(70vh,28rem)] flex-1 flex-col items-center justify-center px-8 py-16 text-center">
    <div class="max-w-sm rounded-[1.35rem] border border-white/70 bg-white/50 px-10 py-12 shadow-[0_24px_80px_-32px_rgba(24,24,27,0.35)] backdrop-blur-md ring-1 ring-zinc-950/[0.04] supports-[backdrop-filter]:bg-white/40">
      ...
      <p class="mt-2 text-sm leading-relaxed text-zinc-500">
        Pick a contact from the list or press <span class="font-medium text-zinc-700">New</span> to create one.
      </p>
    </div>
  </div>
</template>
